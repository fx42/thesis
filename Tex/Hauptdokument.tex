\documentclass[a4paper,12pt,headsepline]{book}

%----------------- PDF CONFIG ----------------- %
\pdfinfo{    
     /Title (Reactive Programming - Von der Theorie zum Praxis) 
     /Subject   (Reactive Programming)    
     /Author  (Felix Scheidel) 
     /Keywords   (Java 8, Reactive Programming, Reactive Systems, RxJava, RxJavaFx)      
} 

\title{Reactive Programming - Von der Theorie zum Praxis}
\author{Felix Scheidel}
\date{\today}
